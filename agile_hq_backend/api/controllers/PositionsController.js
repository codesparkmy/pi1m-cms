...
module.exports = {
    async create(req, res) {
        try {
            ...
            if (!position) {
                return res.status(200).json({ message: "postion is required" });
            } else {
    ...
    async update(req, res) {
        try {
            ...
            if (!position) {
                return res.status(200).json({ message: "position is required" });
            }

            if (!positionId) {
                return res.status(200).json({ message: "positionId is required" });
            }
